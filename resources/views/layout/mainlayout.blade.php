...
<head>
    ...
    <title>@yield('title') | Book Rentals</title>
    ...
    <div class="main d-flex flex-column justify-content-between">
        <nav class="navbar navbar-dark navbar-expand-lg bg-primary">
            <div class="container-fluid">
                <a class="navbar-brand font-weight-bold" href="/">BookRentals</a>
        ...
        <div class="body-content h-100">
            <div class="row g-0 h-100">
                <div class="sidebar col-lg-2 collapse d-lg-block p-0" id="navbarToggler">
                    @if (Auth::user())
                        @if (Auth::user()->role_id == 1)
                            ...
                            <a href="/books" @if (request()->route()->uri == 'books' ||
                                    ...
                                    request()->route()->uri == 'book-deleted-list') class='active' @endif>Books</a>
                            ...
                            <a href="/users" @if (request()->route()->uri == 'users' ||
                                    ...
                                    request()->route()->uri == 'banned-list') class='active' @endif>Users</a>
